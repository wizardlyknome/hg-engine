...
u16 sCherrygroveCityMart[] = {
    ITEM_AIR_MAIL, ITEM_HEAL_BALL, ITEM_INFINITE_CANDY, 0xFFFF
};

u16 sVioletCityMart[] = {
    ITEM_BLACK_BELT, ITEM_EXPERT_BELT, ITEM_FOCUS_SASH, 0xFFFF
};

u16 sAzaleaCityMart[] = {
    ITEM_POWER_HERB, ITEM_MENTAL_HERB, ITEM_WHITE_HERB, 0xFFFF
};

u16 sGoldenrodDepartmentUpper2F[] = {
    ITEM_SCIZORITE, ITEM_CAMERUPTITE, ITEM_LOPUNNITE, ITEM_AERODACTYLITE, ITEM_GALLADITE,
    ITEM_BLAZIKENITE, ITEM_ALTARIANITE, ITEM_GARCHOMPITE, ITEM_METAGROSSITE, ITEM_PINSIRITE,
    ITEM_KANGASKHANITE, ITEM_HERACRONITE, ITEM_SWAMPERTITE, ITEM_GYARADOSITE, ITEM_SHARPEDONITE, 
    ITEM_LUCARIONITE, ITEM_SCEPTILITE, ITEM_SABLENITE, 0xFFFF
};

u16 sGoldenrodDepartmentLower2F[] = {
    ITEM_POKE_BALL, ITEM_GREAT_BALL, ITEM_ULTRA_BALL, ITEM_FAST_BALL, ITEM_LEVEL_BALL, ITEM_LURE_BALL, ITEM_HEAVY_BALL, ITEM_LOVE_BALL, 
    ITEM_FRIEND_BALL, ITEM_MOON_BALL, ITEM_SPORT_BALL, ITEM_PARK_BALL, ITEM_ESCAPE_ROPE, ITEM_POKE_DOLL,
    ITEM_REPEL, ITEM_SUPER_REPEL, ITEM_MAX_REPEL, ITEM_POTION, ITEM_SUPER_POTION, ITEM_HYPER_POTION, ITEM_MAX_POTION, ITEM_REVIVE,
...
u16 sGoldenrodDepartment3F[] = {
    ITEM_PP_UP, ITEM_ABILITY_CAPSULE, ITEM_ABILITY_PATCH, ITEM_LONELY_MINT, ITEM_ADAMANT_MINT, ITEM_NAUGHTY_MINT,
    ITEM_BRAVE_MINT, ITEM_BOLD_MINT, ITEM_IMPISH_MINT, ITEM_LAX_MINT, ITEM_RELAXED_MINT, ITEM_MODEST_MINT, 
    ITEM_MILD_MINT, ITEM_RASH_MINT, ITEM_RASH_MINT, ITEM_CALM_MINT, ITEM_GENTLE_MINT, ITEM_CAREFUL_MINT, ITEM_SASSY_MINT, 
    ITEM_TIMID_MINT, ITEM_HASTY_MINT, ITEM_JOLLY_MINT, ITEM_NAIVE_MINT, ITEM_SERIOUS_MINT, 0xFFFF
};

u16 sGoldenrodDepartment4F[] = {
    ITEM_SUN_STONE, ITEM_MOON_STONE, ITEM_FIRE_STONE, ITEM_THUNDER_STONE, ITEM_WATER_STONE,
    ITEM_LEAF_STONE, ITEM_ICE_STONE, ITEM_EVERSTONE, ITEM_EVIOLITE, ITEM_SHINY_STONE, ITEM_DUSK_STONE, ITEM_DAWN_STONE, ITEM_LINKING_CORD,
    ITEM_PROTECTOR, ITEM_ELECTIRIZER, ITEM_MAGMARIZER, ITEM_REAPER_CLOTH, ITEM_OVAL_STONE, ITEM_KINGS_ROCK, ITEM_RAZOR_CLAW, 
    ITEM_RAZOR_FANG, ITEM_PRISM_SCALE, ITEM_SACHET, ITEM_UP_GRADE, ITEM_WHIPPED_DREAM, ITEM_WEAKNESS_POLICY, ITEM_AUSPICIOUS_ARMOR, ITEM_MALICIOUS_ARMOR, 0xFFFF
};
