...
OVERWORLDS_EXTRA_SRCS := $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/extra/*.png) $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/extra/*.json) $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/extra/*.pal)
OVERWORLDS_EXTRA_OBJS := $(patsubst $(OVERWORLDS_DEPENDENCIES_DIR)/extra/%.png,$(OVERWORLDS_DIR)/2_%.btx0,$(OVERWORLDS_EXTRA_SRCS))

# add your own overworld sources here
ALL_OVERWORLDS_SRCS := $(OVERWORLDS_SRCS) $(OVERWORLDS_EXTRA_SRCS)
ALL_OVERWORLDS_OBJS := $(OVERWORLDS_OBJS) $(OVERWORLDS_EXTRA_OBJS)
